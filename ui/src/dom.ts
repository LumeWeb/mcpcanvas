// Shared DOM helpers for the MCP Apps. Each app resolves its host-rendered
...
/** Status readout classes shared by flow and link apps. */
...
/**
 * Resolve a typed element by id. Returns `null` when the host-rendered shell is
