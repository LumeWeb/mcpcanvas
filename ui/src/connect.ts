...
// the @modelcontextprotocol/ext-apps package to establish the postMessage
// bridge to the MCP host.
//
// The sandboxed ui:// iframe cannot resolve file imports, so the bundle the
// consuming product emits must be fully self-contained; the whole ext-apps
// client + MCP SDK + zod are inlined into each app bundle.
