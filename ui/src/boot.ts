...
// self-contained by the consumer's bundler. On connection failure the shared
// status element shows the "Could not connect to host" error.
 ...
 * the runtime build version. Shared by the flow and link mount helpers. */
