// Behavioral tests for the robot3 one-shot link machine (link.ts). Uses
// deferred (gated) promises to pause an `invoke` mid-flight, per the robot3
// pattern.

import { beforeEach, describe, expect, it } from "vitest";
import { interpret, type Service } from "robot3";
import { createLinkMachine, currentLinkState, LinkState, renderLink, type CallTool, type LinkConfig, type ToolResult } from "../src/link";
